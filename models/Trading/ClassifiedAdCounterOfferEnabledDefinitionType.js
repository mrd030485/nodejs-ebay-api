	...
	/**
	  Documentation
	   Type defining the <b>ClassifiedAdCounterOfferEnabled</b> field that is returned under the <b>FeatureDefinitions</b> container of the <b>GetCategoryFeatures</b> response (as long as 'ClassifiedAdCounterOfferEnabled'
                    ...
                    or more eBay API-enabled sites support the Classified Ad Best Offer Counter Offer feature. <br/><br/> To verify if a specific eBay site supports the Classified Ad Best Offer Counter Offer feature (for most categories),
                    look for a 'true' value in the <b>SiteDefaults.ClassifiedAdCounterOfferEnabled</b> field. <br/><br/> To verify if a specific category on a specific eBay site supports the Classified Ad Best Offer Counter Offer
                    feature, pass in a <b>CategoryID</b> value in the request, and then look for a 'true' value in the <b>ClassifiedAdCounterOfferEnabled</b> field of the corresponding Category node (match up the <b>CategoryID</b>
