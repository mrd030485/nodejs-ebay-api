...
function DiscountPriceInfoType(OriginalRetailPrice, MinimumAdvertisedPrice, MinimumAdvertisedPriceExposure, PricingTreatment, SoldOneBay, SoldOffeBay, MadeForOutletComparisonPrice) {
	...
	/**
	  Documentation
	   Using this container, a seller can supply original retail price and discount price for an item to clarify the discount treatment (also known as strike-through pricing). This only applies to fixed-price listings and auction listings with
                    the Buy It Now option. This feature is available for large enterprise sellers via white list. A seller can provide discount treatment regardless of whether the listing includes a SKU.
	 */
...
DiscountPriceInfoType.prototype.toJSON = function(with_null) {
	var json = { 
		...
		MinimumAdvertisedPriceExposure: (this.MinimumAdvertisedPriceExposure === undefined)? null : this.MinimumAdvertisedPriceExposure,
		PricingTreatment: (this.PricingTreatment === undefined)? null : this.PricingTreatment,
