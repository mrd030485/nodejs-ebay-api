...
ItemType.prototype.toJSON = function(with_null) {
	var json = { 
		...
		AttributeArray: (this.AttributeArray === undefined)? null : this.AttributeArray.toJSON(),
		LookupAttributeArray: (this.LookupAttributeArray === undefined)? null : this.LookupAttributeArray.toJSON(),
		...
		PrimaryCategory: (this.PrimaryCategory === undefined)? null : this.PrimaryCategory.toJSON(),
		...
		FreeAddedCategory: (this.FreeAddedCategory === undefined)? null : this.FreeAddedCategory.toJSON(),
		Seller: (this.Seller === undefined)? null : this.Seller.toJSON(),
		...
		UUID: (this.UUID === undefined)? null : this.UUID.toJSON(),
		...
		SearchDetails: (this.SearchDetails === undefined)? null : this.SearchDetails.toJSON(),
		...
		PictureDetails: (this.PictureDetails === undefined)? null : this.PictureDetails.toJSON(),
		...
		SellerContactDetails: (this.SellerContactDetails === undefined)? null : this.SellerContactDetails.toJSON(),
		...
		ExtendedSellerContactDetails: (this.ExtendedSellerContactDetails === undefined)? null : this.ExtendedSellerContactDetails.toJSON(),
		...
		QuantityInfo: (this.QuantityInfo === undefined)? null : this.QuantityInfo.toJSON(),
		SellerProfiles: (this.SellerProfiles === undefined)? null : this.SellerProfiles.toJSON(),
		ShippingServiceCostOverrideList: (this.ShippingServiceCostOverrideList === undefined)? null : this.ShippingServiceCostOverrideList.toJSON(),
		...
		DigitalGoodInfo: (this.DigitalGoodInfo === undefined)? null : this.DigitalGoodInfo.toJSON(),
