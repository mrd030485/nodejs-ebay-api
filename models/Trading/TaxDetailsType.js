...
function TaxDetailsType(Imposition, TaxDescription, TaxAmount, TaxOnSubtotalAmount, TaxOnShippingAmount, TaxOnHandlingAmount, TaxCode) {
	...
	/**
	  Documentation
	   Type defining the TaxDetails container, which consists of detailed sales tax information for an order line item, including the tax type and description, sales tax on the item cost, and sales tax related to shipping and handling. The information
...
TaxDetailsType.prototype.toJSON = function(with_null) {
	var json = { 
		Imposition: (this.Imposition === undefined)? null : this.Imposition,
		TaxDescription: (this.TaxDescription === undefined)? null : this.TaxDescription,
